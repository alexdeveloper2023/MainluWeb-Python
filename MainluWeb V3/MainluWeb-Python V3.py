...
class MainluWeb(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.web.load(QtCore.QUrl("https://www.bing.com"))
        self.setWindowTitle(self.web.page().title() + "- MainluWeb-Python V3 - AlSoftP")
        ...
        self.url.setText("https://www.bing.com")
        ...
        #Buscar con la palabra puesta en el campo de texto y con Microsoft Bing al presionar la tecla Enter
    ...
    def searching(self):
        self.web.load(QtCore.QUrl("https://www.bing.com/search?q=" + self.url.text()))
        
        #Si se ha buscado la palabra y se vuelve a buscar con la url se recarga la página
        if self.url.text() == QtCore.QUrl("https://www.bing.com/search?q=" + self.url.text()):
            self.web.reload()
